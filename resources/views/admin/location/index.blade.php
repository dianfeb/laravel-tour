                            ...
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-outline-danger btn-delete"  href="#" onClick="deletelocation(this)" data-id="{{ $row->id }}">
                                            <i class="badge-circle badge-circle-white text-secondary font-medium-1"
...
{{-- modal create data --}}
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Add location </h4>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('location/'.$row->id) }}" method="post">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <label class="mb-2">location </label>
